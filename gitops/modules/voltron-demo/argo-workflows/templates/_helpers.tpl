...
{{/*
Registry cache repository passed to docker/docker-bake.hcl via CACHE_REPO.
*/}}
{{- define "voltron-demo.cacheRepo" -}}
{{- printf "%s/%s/%s" (include "voltron-demo.registry" .) .Values.gcpProjectId .Values.spec.cacheArtifactPathName -}}
{{- end -}}
